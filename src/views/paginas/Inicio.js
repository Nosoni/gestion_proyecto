            ...
            <Container fluid>
              {
                <Row>
                  {
                    localStorage.getItem(PERMISOSCONST.VER_MENU_ADMINISTRACION)?.length > 0 &&
                    <Col lg="4" xl="4">
                  ...
                  {
                    localStorage.getItem(PERMISOSCONST.VER_MENU_CONFIGURACION)?.length > 0 &&
                    <Col lg="4" xl="4">
                  ...
                  {
                    localStorage.getItem(PERMISOSCONST.VER_MENU_DESARROLLO)?.length > 0 &&
                    <Col lg="4" xl="4">
