...
const servicioCantidadView = "usuario_rol_cantidad_view";
...
const usuarioRolCantidadViewGetAll = async () => {
...
export {
  usuarioRolGetByUsuario, usuarioRolAsignar, usuarioRolDeshabilitar,
  usuarioRolViewGetByUsuario, usuarioRolCantidadViewGetAll
};
